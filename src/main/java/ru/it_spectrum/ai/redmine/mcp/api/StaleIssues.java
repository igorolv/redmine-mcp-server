...
public record StaleIssues(
        @Schema(description = "Project identifier the search was scoped to.", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
        String projectId,
    ...
    public record Entry(
            @Schema(description = "The stale issue.", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
            IssueSummary issue,
