...
public record AttachmentContent(
        @Schema(description = "Attachment metadata.", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
        Attachment attachment,
        @Schema(description = "Absolute filesystem path of the downloaded file.", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
        String localPath,
        @Schema(description = "RFC 3986 `file://` URI pointing at the downloaded file.", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
        String fileUri,
        ...
        long localSize,
        @Schema(description = "Detected document kind used for extraction (`image`, `pdf`, `docx`, `xlsx`, `pptx`, `text`, `zip`, ...).", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public record Part(
            @Schema(description = "Logical name of the part (file name within a ZIP, or the attachment file name).", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
            String name,
            @Schema(description = "Logical name of the part this one was extracted from (e.g. the enclosing ZIP file). Null for parts produced directly from the top-level attachment.", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
            String parent,
            @Schema(description = "Detected document kind for this specific part.", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
            String extractionType,
            @Schema(description = "Identifier of the parser that produced this part (e.g. `PlainTextParser`, `ZipParser`). Useful for debugging which extractor handled the file.", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
            String producer,
            ...
            boolean truncated,
            @Schema(description = "Extracted text, null when extraction was skipped or failed.", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
            String content,
            @Schema(description = "Absolute filesystem path to the file this part refers to (the source file itself, or an artefact extracted to disk). Null when no underlying file exists (e.g. a manifest-only stub).", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
            String localPath,
            @Schema(description = "RFC 3986 `file://` URI matching `localPath`. Null when `localPath` is null.", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
            String fileUri,
