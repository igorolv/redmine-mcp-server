...
public record VersionChangelog(
        ...
        boolean truncated,
        @Schema(description = "Issues grouped by tracker name (Bug, Feature, ...).", requiredMode = Schema.RequiredMode.REQUIRED, nullable = true)
        Map<String, List<IssueSummary>> byTracker,
        @Schema(description = "Open / closed / total counts within the analyzed set.", requiredMode = Schema.RequiredMode.REQUIRED, nullable = true)
