...
public record Query(
        @Schema(description = "Query identifier. Pass as queryId to listIssues.", requiredMode = Schema.RequiredMode.REQUIRED)
        int id,
        @Schema(description = "Display name shown in the Redmine UI.", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
        String name,
        ...
        boolean isPublic,
        @Schema(description = "Project the query is scoped to. Null for cross-project queries.", requiredMode = Schema.RequiredMode.NOT_REQUIRED, nullable = true)
        Integer projectId
) {
